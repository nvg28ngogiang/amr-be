...
//        Field[] fields = ParagraphDTO.class.getDeclaredFields();
    ...
    public FormResult getAllSentenceOfParagraph(String username, Long divId, Long paragraphId) {
        ...
        for (Object[] obj : objs) {
            ...
            item.setDivId(obj[1] != null ? Long.valueOf(obj[1].toString()) : null);
            item.setParagraphId(obj[2] != null ? Long.valueOf(obj[2].toString()) : null);
            item.setSentenceId(obj[3] != null ? Long.valueOf(obj[3].toString()) : null);
            item.setContent(obj[4] != null ? obj[4].toString() : "");
            listResponse.add(item);
        }
        result.setContent(listResponse);
    ...
    private StringBuilder generateGetAllSentenceOfParagraph() {
        StringBuilder sql = new StringBuilder("select  " +
                "distinct (concat(a.div_id, '_', a.paragraph_id, '_', a.sentence_id))" +
                ", a.div_id as divId  " +
                ", a.paragraph_id as paragraphId " +
